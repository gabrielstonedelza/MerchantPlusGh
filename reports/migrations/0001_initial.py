    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('transaction_summary', 'Transaction Summary'), ('agent_performance', 'Agent Performance'), ('customer_activity', 'Customer Activity'), ('revenue_report', 'Revenue Report'), ('daily_reconciliation', 'Daily Reconciliation')], max_length=30)),
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saved_reports', to='core.company')),
